...
namespace KoganeUnityLib.StringExt
{
    /// <summary>
    ...
    public static class StringExt
    {
        ...
        public static string ConcatWith<T>(this IEnumerable<T> self, string separator)
        {
            ...
            foreach (T n in self) list.Add(n.ToString());
        ...
        public static string ConcatWith(this IEnumerable self, string separator)
        {
            ...
            foreach (object n in self) list.Add(n);
        ...
        public static int GetByteCount(this string self)
        {
            ...
            {
                if (StringUtils.IsChar2Byte(self[i])) count++;
                count++;
            }
            return count;
        }
        ...
        public static string SubstringInByte(this string self, int byteCount)
        {
            ...
            {
                char c = self[i];
                if (StringUtils.IsChar2Byte(c)) count++;
                count++;
        ...
        public static string Repeat(this string self, int repeatCount)
        {
            ...
            for (var i = 0; i < repeatCount; i++) builder.Append(self);
        ...
        {
            while (remainCount < self.CountString(str)) self = self.Remove(self.IndexOf(str), str.Length);
            return self;
        }
        ...
        {
            while (remainCount < self.CountString(str)) self = self.Remove(self.LastIndexOf(str), str.Length);
            return self;
        }
