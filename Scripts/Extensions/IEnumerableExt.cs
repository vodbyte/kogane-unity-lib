...
namespace KoganeUnityLib.EnumerableExt
{
    /// <summary>
    ...
    public static class IEnumerableExt
    {
        ...
        {
            var index = 0;
            foreach (T n in self) action(n, index++);
        }
        ...
        /// </summary>
        public static bool SequenceEqual<T, TKey>(this IEnumerable<T> source,
        ...
        /// </summary>
        public static TSource MaxBy<TSource, TResult>(this IEnumerable<TSource> source,
        ...
        /// </summary>
        public static IEnumerable<TSource> MaxElementsBy<TSource, TResult>(this IEnumerable<TSource> source,
                                                                           Func<TSource, TResult> selector)
        {
            TResult value = source.Max(selector);
        ...
        /// </summary>
        public static TSource MinBy<TSource, TResult>(this IEnumerable<TSource> source,
                                                      Func<TSource, TResult> selector)
        {
            TResult value = source.Min(selector);
            return source.FirstOrDefault(c => selector(c).Equals(value));
        }
        ...
        /// </summary>
        public static IEnumerable<TSource> MinElementsBy<TSource, TResult>(this IEnumerable<TSource> source,
                                                                           Func<TSource, TResult> selector)
        {
            TResult value = source.Min(selector);
            return source.Where(c => selector(c).Equals(value));
        ...
        ///     シーケンスの先頭に値を追加して返します
        /// </summary>
        public static IEnumerable<TSource> StartWith<TSource>(this IEnumerable<TSource> source,
                                                              params TSource[] value)
        {
            foreach (TSource n in value) yield return n;
            foreach (TSource n in source) yield return n;
        }
        ...
        /// </summary>
        public static IEnumerable<TSource> WhereNot<TSource, TResult>(this IEnumerable<TSource> source,
        ...
        ///     目的の値に最も近い値を返します
        /// </summary>
        public static int Nearest(this IEnumerable<int> self,
                                  int target)
        {
        ...
        ///     目的の値に最も近い値を返します
        /// </summary>
        public static int Nearest<TSource>(this IEnumerable<TSource> self,
                                           int target,
        ...
        /// </summary>
        public static TSource FindNearest<TSource>(this IEnumerable<TSource> self,
                                                   int target,
                                                   Func<TSource, int> selector)
        {
            int min = self.Min(c => Math.Abs(selector(c) - target));
        ...
        /// </summary>
        public static int NearestMoreThan(this IEnumerable<int> self,
                                          int target)
        {
        ...
        ///     目的の値に最も近く、目的の値より大きい値を返します
        /// </summary>
        public static int NearestMoreThan<TSource>(this IEnumerable<TSource> self,
                                                   int target,
                                                   Func<TSource, int> selector)
        {
        ...
        /// </summary>
        public static TSource FindNearestMoreThan<TSource>(this IEnumerable<TSource> self,
                                                           int target,
                                                           Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => target < selector(c)).ToArray();
        ...
        /// </summary>
        public static int NearestOrLess(this IEnumerable<int> self,
                                        int target)
        {
            IEnumerable<int> list = self.Where(c => c <= target);
            int min = list.Min(c => Math.Abs(c - target));
            return list.FirstOrDefault(c => Math.Abs(c - target) == min);
        }
        ...
        ///     目的の値に最も近く、目的の値以下の値を返します
        /// </summary>
        public static int NearestOrLess<TSource>(this IEnumerable<TSource> self,
                                                 int target,
                                                 Func<TSource, int> selector)
        {
            IEnumerable<TSource> list = self.Where(c => selector(c) <= target);
            int min = list.Min(c => Math.Abs(selector(c) - target));
            return selector(list.FirstOrDefault(c => Math.Abs(selector(c) - target) == min));
        }
        ...
        ///     目的の値に最も近く、目的の値以下の値を返します
        /// </summary>
        public static TSource FindNearestOrLess<TSource>(this IEnumerable<TSource> self,
                                                         int target,
                                                         Func<TSource, int> selector)
        {
            IEnumerable<TSource> list = self.Where(c => selector(c) <= target);
        ...
        /// </summary>
        public static int NearestOrMore(this IEnumerable<int> self,
                                        int target)
        {
            IEnumerable<int> list = self.Where(c => target <= c);
            int min = list.Min(c => Math.Abs(c - target));
            return list.FirstOrDefault(c => Math.Abs(c - target) == min);
        }
        ...
        ///     目的の値に最も近く、目的の値以上の値を返します
        /// </summary>
        public static int NearestOrMore<TSource>(this IEnumerable<TSource> self,
                                                 int target,
                                                 Func<TSource, int> selector)
        {
            IEnumerable<TSource> list = self.Where(c => target <= selector(c));
            int min = list.Min(c => Math.Abs(selector(c) - target));
            return selector(list.FirstOrDefault(c => Math.Abs(selector(c) - target) == min));
        }
        ...
        ///     目的の値に最も近く、目的の値以上の値を返します
        /// </summary>
        public static TSource FindNearestOrMore<TSource>(this IEnumerable<TSource> self,
                                                         int target,
                                                         Func<TSource, int> selector)
        {
            IEnumerable<TSource> list = self.Where(c => target <= selector(c));
        ...
        /// </summary>
        public static int NearestMoreLess(this IEnumerable<int> self,
                                          int target)
        {
        ...
        ///     目的の値に最も近く、目的の値より小さい値を返します
        /// </summary>
        public static int NearestMoreLess<TSource>(this IEnumerable<TSource> self,
                                                   int target,
                                                   Func<TSource, int> selector)
        {
        ...
        /// </summary>
        public static TSource FindNearestMoreLess<TSource>(this IEnumerable<TSource> self,
                                                           int target,
                                                           Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => selector(c) < target).ToArray();
        ...
        {
            var current = 0;
            int rate = m_random.Next(0, self.Sum(selector));

            T result = self.FirstOrDefault(c =>
            {
                current += selector(c);
                return rate < current;
            });
        ...
        ///  }
        ///  </code>
        public static Tuple<IEnumerable<T>, IEnumerable<T>> Partition<T>(this IEnumerable<T> self,
