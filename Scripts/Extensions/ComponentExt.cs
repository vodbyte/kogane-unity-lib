...
namespace KoganeUnityLib.ComponentExt
{
    /// <summary>
    ...
    public static class ComponentExt
    {
        ...
        {
            foreach (T component in self.GetComponents<T>()) Object.Destroy(component);
        }
        ...
        {
            foreach (T component in self.GetComponents<T>()) Object.DestroyImmediate(component);
        }
        ...
        {
            Transform result = self.transform.Find(name);
        ...
        {
            self.transform.position = new Vector3(self.transform.position.x + x,
                                                  self.transform.position.y,
                                                  self.transform.position.z);
        }
        ...
        {
            self.transform.position = new Vector3(self.transform.position.x + v.x,
        ...
        {
            self.transform.localScale = new Vector3(self.transform.localScale.x + x,
        ...
        {
            self.transform.localScale = new Vector3(self.transform.localScale.x,
        ...
        public static void SetLayerRecursively(this Component self, int layer)
        {
            ...
            foreach (Transform n in self.gameObject.transform) SetLayerRecursively(n, layer);
        }
        ...
        {
            for (Transform parent = self.transform.parent; null != parent; parent = parent.parent) yield return parent;
        }
        ...
        {
            Vector3 v = self.transform.localEulerAngles;
            v.x = Mathf.Round(v.x);
            v.y = Mathf.Round(v.y);
            v.z = Mathf.Round(v.z);
            self.transform.localEulerAngles = v;
