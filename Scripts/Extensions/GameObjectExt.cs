...
namespace KoganeUnityLib.GameObjectExt
{
    /// <summary>
    ...
    public static class GameObjectExt
    {
        ...
        public static GameObject[] GetAllParent(this GameObject self)
        {
            ...
            for (Transform parent = self.transform.parent; parent != null; parent = parent.parent)
        ...
        public static T GetComponentInterface<T>(this GameObject self) where T : class
        {
            ...
            {
                if (n is T component) return component;
            }
            return null;
        }
        ...
        public static T[] GetComponentInterfaces<T>(this GameObject self) where T : class
        {
            ...
            foreach (Component n in self.GetComponents<Component>())
            {
                if (n is T component) result.Add(component);
            }
            return result.ToArray();
        }
