...
namespace KoganeUnityLib.ArrayExt
{
    /// <summary>
    ///     配列の拡張メソッドを管理するクラス
    /// </summary>
    public static class ArrayExt
    {
        ...
        {
            return array.IsNotNullOrEmpty() ? array[UnityEngine.Random.Range(0, array.Length)] : default;
        }
        ...
        /// </summary>
        /// \
        public static void Sort<TSource, TResult>(this TSource[] array,
