...
namespace KoganeUnityLib.FuncExt
{
    /// <summary>
    ...
    public static class FuncExt
    {
        ...
        /// </summary>
        public static TResult Call<TResult>(this Func<TResult> self, TResult result = default)
        {
        ...
        /// </summary>
        public static TResult Call<T, TResult>(this Func<T, TResult> self, T arg, TResult result = default)
        {
        ...
        /// </summary>
        public static TResult Call<T1, T2, TResult>(this Func<T1, T2, TResult> self,
                                                    T1 arg1,
                                                    T2 arg2,
        ...
        /// </summary>
        public static TResult Call<T1, T2, T3, TResult>(this Func<T1, T2, T3, TResult> self,
                                                        T1 arg1,
                                                        T2 arg2,
                                                        T3 arg3,
                                                        TResult result = default)
