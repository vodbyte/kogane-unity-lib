...
namespace KoganeUnityLib.EnumExt
{
    /// <summary>
    ...
    public static class EnumExt
    {
        ...
        public static T PrevLoop<T>(this T self)
        {
            ...
            int length = EnumUtils.GetLength<T>();
        ...
        {
            var intValue = Convert.ToInt32(self);
            int nextValue = (intValue + 1) % EnumUtils.GetLength<T>();
            var enumValue = EnumUtils.ToObject<T>(nextValue);
        ...
        /// </summary>
        public static T Next<T>(this T self) where T : Enum
        {
            var intValue = Convert.ToInt32(self);
            int nextValue = Mathf.Min(EnumUtils.GetLength<T>(), intValue + 1);
            var enumValue = EnumUtils.ToObject<T>(nextValue);
