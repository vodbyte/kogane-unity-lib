...
using KoganeUnityLib.EnumerableExt;

using Random = UnityEngine.Random;

namespace KoganeUnityLib.IListExt
{
    /// <summary>
    ...
    public static class IListExt
    {
        ...
        {
            return self.IsEmpty() ? default : self[Random.Range(0, self.Count)];
        }
        ...
        {
            for (int i = self.Count - 1; 0 <= i; i--) act(self[i]);
        }
        ...
        {
            for (int i = self.Count - 1; 0 <= i; i--) act(self[i], i);
        }
        ...
        {
            for (var i = 0; i < self.Count; i++) act(self[i]);
        }
        ...
        {
            for (var i = 0; i < self.Count; i++) act(self[i], i);
        }
        ...
        public static int Sum<T>(this IList<T> self, Func<T, int> selector)
        {
            ...
            for (var i = 0; i < self.Count; i++) result += selector(self[i]);
            return result;
        }
        ...
        /// </summary>
        public static int Nearest(this IList<int> self,
                                  int target)
        {
        ...
        ///     目的の値に最も近い値を返します。見つからなかった場合は例外を投げます
        /// </summary>
        public static int Nearest<TSource>(this IList<TSource> self,
                                           int target,
        ...
        /// </summary>
        public static TSource FindNearest<TSource>(this IList<TSource> self,
                                                   int target,
                                                   Func<TSource, int> selector)
        {
            int min = self.Min(c => Math.Abs(selector(c) - target));
        ...
        /// </summary>
        public static int NearestOrDefault(this IList<int> self,
                                           int target)
        {
            int min = self.Min(c => Math.Abs(c - target));
        ...
        ///     目的の値に最も近い値を返します。見つからなかった場合は null を返します
        /// </summary>
        public static int NearestOrDefault<TSource>(this IList<TSource> self,
                                                    int target,
                                                    Func<TSource, int> selector)
        {
            int min = self.Min(c => Math.Abs(selector(c) - target));
        ...
        /// </summary>
        public static TSource FindNearestOrDefault<TSource>(this IList<TSource> self,
                                                            int target,
                                                            Func<TSource, int> selector)
        {
            int min = self.Min(c => Math.Abs(selector(c) - target));
        ...
        /// </summary>
        public static int NearestMoreThan(this IList<int> self,
                                          int target)
        {
        ...
        ///     目的の値に最も近く、目的の値より大きい値を返します。見つからなかった場合は例外を投げます
        /// </summary>
        public static int NearestMoreThan<TSource>(this IList<TSource> self,
                                                   int target,
                                                   Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => target < selector(c)).ToArray();
        ...
        /// </summary>
        public static TSource FindNearestMoreThan<TSource>(this IList<TSource> self,
                                                           int target,
                                                           Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => target < selector(c)).ToArray();
        ...
        /// </summary>
        public static int NearestMoreThanOrDefault(this IList<int> self,
                                                   int target)
        {
            int[] list = self.Where(c => target < c).ToArray();
            int min = list.Min(c => Math.Abs(c - target));
        ...
        ///     目的の値に最も近く、目的の値より大きい値を返します。見つからなかった場合は null を返します
        /// </summary>
        public static int NearestMoreThanOrDefault<TSource>(this IList<TSource> self,
                                                            int target,
                                                            Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => target < selector(c)).ToArray();
        ...
        /// </summary>
        public static TSource FindNearestMoreThanOrDefault<TSource>(this IList<TSource> self,
                                                                    int target,
                                                                    Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => target < selector(c)).ToArray();
        ...
        /// </summary>
        public static int NearestOrLess(this IList<int> self,
                                        int target)
        {
            int[] list = self.Where(c => c <= target).ToArray();
            int min = list.Min(c => Math.Abs(c - target));
            return list.First(c => Math.Abs(c - target) == min);
        }
        ...
        ///     目的の値に最も近く、目的の値以下の値を返します。見つからなかった場合は例外を投げます
        /// </summary>
        public static int NearestOrLess<TSource>(this IList<TSource> self,
                                                 int target,
                                                 Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => selector(c) <= target).ToArray();
            int min = list.Min(c => Math.Abs(selector(c) - target));
            return selector(list.First(c => Math.Abs(selector(c) - target) == min));
        }
        ...
        ///     目的の値に最も近く、目的の値以下の値を返します。見つからなかった場合は例外を投げます
        /// </summary>
        public static TSource FindNearestOrLess<TSource>(this IList<TSource> self,
                                                         int target,
                                                         Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => selector(c) <= target).ToArray();
        ...
        /// </summary>
        public static int NearestOrLessOrDefault(this IList<int> self,
                                                 int target)
        {
            int[] list = self.Where(c => c <= target).ToArray();
            int min = list.Min(c => Math.Abs(c - target));
        ...
        ///     目的の値に最も近く、目的の値以下の値を返します。見つからなかった場合は null を返します
        /// </summary>
        public static int NearestOrLessOrDefault<TSource>(this IList<TSource> self,
                                                          int target,
                                                          Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => selector(c) <= target).ToArray();
        ...
        ///     目的の値に最も近く、目的の値以下の値を返します。見つからなかった場合は null を返します
        /// </summary>
        public static TSource FindNearestOrLessOrDefault<TSource>(this IList<TSource> self,
                                                                  int target,
                                                                  Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => selector(c) <= target).ToArray();
        ...
        /// </summary>
        public static int NearestOrMore(this IList<int> self,
                                        int target)
        {
            int[] list = self.Where(c => target <= c).ToArray();
            int min = list.Min(c => Math.Abs(c - target));
        ...
        ///     目的の値に最も近く、目的の値以上の値を返します。見つからなかった場合は例外を投げます
        /// </summary>
        public static int NearestOrMore<TSource>(this IList<TSource> self,
                                                 int target,
                                                 Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => target <= selector(c)).ToArray();
        ...
        ///     目的の値に最も近く、目的の値以上の値を返します。見つからなかった場合は例外を投げます
        /// </summary>
        public static TSource FindNearestOrMore<TSource>(this IList<TSource> self,
                                                         int target,
                                                         Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => target <= selector(c)).ToArray();
        ...
        /// </summary>
        public static int NearestOrMoreOrDefault(this IList<int> self,
                                                 int target)
        {
            int[] list = self.Where(c => target <= c).ToArray();
            int min = list.Min(c => Math.Abs(c - target));
        ...
        ///     目的の値に最も近く、目的の値以上の値を返します。見つからなかった場合は null を返します
        /// </summary>
        public static int NearestOrMoreOrDefault<TSource>(this IList<TSource> self,
                                                          int target,
                                                          Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => target <= selector(c)).ToArray();
        ...
        ///     目的の値に最も近く、目的の値以上の値を返します。見つからなかった場合は null を返します
        /// </summary>
        public static TSource FindNearestOrMoreOrDefault<TSource>(this IList<TSource> self,
                                                                  int target,
                                                                  Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => target <= selector(c)).ToArray();
        ...
        /// </summary>
        public static int NearestMoreLess(this IList<int> self,
                                          int target)
        {
            int[] list = self.Where(c => c < target).ToArray();
            int min = list.Min(c => Math.Abs(c - target));
        ...
        ///     目的の値に最も近く、目的の値より小さい値を返します。見つからなかった場合は例外を投げます
        /// </summary>
        public static int NearestMoreLess<TSource>(this IList<TSource> self,
                                                   int target,
                                                   Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => selector(c) < target).ToArray();
        ...
        /// </summary>
        public static TSource FindNearestMoreLess<TSource>(this IList<TSource> self,
                                                           int target,
                                                           Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => selector(c) < target).ToArray();
        ...
        /// </summary>
        public static int NearestMoreLessOrDefault(this IList<int> self,
                                                   int target)
        {
            int[] list = self.Where(c => c < target).ToArray();
            int min = list.Min(c => Math.Abs(c - target));
        ...
        ///     目的の値に最も近く、目的の値より小さい値を返します。見つからなかった場合は null を返します
        /// </summary>
        public static int NearestMoreLessOrDefault<TSource>(this IList<TSource> self,
                                                            int target,
                                                            Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => selector(c) < target).ToArray();
        ...
        /// </summary>
        public static TSource FindNearestMoreLessOrDefault<TSource>(this IList<TSource> self,
                                                                    int target,
                                                                    Func<TSource, int> selector)
        {
            TSource[] list = self.Where(c => selector(c) < target).ToArray();
        ...
        {
            for (var i = 0; i < list.Count; i++) list[i] = func(list[i], i);
        }
